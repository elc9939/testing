...
export const persistenceRows = [
  ...
  },
  {
    ...
    feature: 'Career Desk',
    owner: 'hub-api',
    savedWhere: 'Jobs are saved through the Hub API personal workspace, persisted in the local core-data snapshot, and mirrored into the browser cache.',
    reloadBehavior: 'Jobs reload from the API snapshot/cache after navigation, browser reload, or local API restart; filters and view state reload from browser storage.',
  ...
  },
  {
    ...
    feature: 'Study Desk',
    owner: 'hub-api',
    savedWhere: 'Study sessions are saved through the Hub API personal workspace, persisted in the local core-data snapshot, and mirrored into the browser cache.',
    reloadBehavior: 'Logs reload from the API snapshot/cache after navigation, browser reload, or local API restart; quick-log defaults, filters, progress, and analytics rehydrate from browser/API data.',
  ...
  },
  {
    ...
    owner: 'hub-api',
    savedWhere: 'Supported game runs and state save through the Hub API core-data snapshot; legacy/playground state may remain browser-local.',
    reloadBehavior: 'Playable pages reload locally; supported high scores and runs rehydrate from cache/API after browser reloads or local API restarts.',
