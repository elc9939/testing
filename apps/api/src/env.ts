...
export const env = {
  ...
  attentionSourceTimeoutMs: Number(
    process.env.MINI_HUB_ATTENTION_SOURCE_TIMEOUT_MS ??
      Math.min(Number(process.env.MINI_HUB_ACTION_LEDGER_TIMEOUT_MS ?? 8000), 6000)
  ),
